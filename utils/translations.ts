...
const enTranslations = {
  ...
  deleteUserConfirm: "Are you sure you want to delete user {email}? This action cannot be undone.",
  userDeleted: "User deleted successfully.",
  accountSecurity: "Account Security",
  changePassword: "Change Password",
  updatePasswordDesc: "Update your password regularly to keep your account secure.",
...
const viTranslations = {
  ...
  taskDistribution: "Phân Bố Công Việc",
  noTasksFound: "Không có công việc nào trong khoảng thời gian này",
  ...
  deleteUserConfirm: "Bạn có chắc chắn muốn xóa người dùng {email}? Hành động này không thể hoàn tác.",
  userDeleted: "Đã xóa người dùng thành công.",
  accountSecurity: "Bảo mật tài khoản",
  changePassword: "Đổi mật khẩu",
  updatePasswordDesc: "Cập nhật mật khẩu thường xuyên để giữ tài khoản an toàn.",
...
const zhTranslations = {
  ...
  userManagement: "账户管理",
  searchUsers: "搜索用户...",
  deleteUserConfirm: "您确定要删除用户 {email} 吗？此操作无法撤销。",
  userDeleted: "用户删除成功。",
  accountSecurity: "账户安全",
  changePassword: "修改密码",
  updatePasswordDesc: "定期更新密码以确保账户安全。",
  newPassword: "新密码",
...
const jaTranslations = {
  ...
  reportHeader: "分析",
  taskDistribution: "タスクの分布",
  noTasksFound: "この期間のタスクは見つかりませんでした",
  ...
  searchUsers: "ユーザーを検索...",
  deleteUserConfirm: "ユーザー {email} を削除してもよろしいですか？この操作は取り消せません。",
  userDeleted: "ユーザーを削除しました。",
  accountSecurity: "アカウントセキュリティ",
  changePassword: "パスワード変更",
  updatePasswordDesc: "定期的にパスワードを更新して、アカウントの安全を確保してください。",
...
const deTranslations = {
  ...
  noTasksFound: "Keine Aufgaben für diesen Zeitraum gefunden",
  ...
  userManagement: "Kontenverwaltung",
  searchUsers: "Benutzer suchen...",
  deleteUserConfirm: "Sind Sie sicher, dass Sie den Benutzer {email} löschen möchten? Diese Aktion kann nicht rückgängig gemacht werden.",
  userDeleted: "Benutzer erfolgreich gelöscht.",
  accountSecurity: "Kontosicherheit",
  changePassword: "Passwort ändern",
  updatePasswordDesc: "Aktualisieren Sie Ihr Passwort regelmäßig, um Ihr Konto sicher zu halten.",
...
const frTranslations = {
  ...
  noTasksFound: "Aucune tâche trouvée pour cette période",
  reportSubHeader: "Performance",
  day: "Jour",
  week: "Semaine",
  month: "Mois",
  ...
  deleteUserConfirm: "Êtes-vous sûr de vouloir supprimer l'utilisateur {email} ? Cette action est irréversible.",
  userDeleted: "Utilisateur supprimé avec succès.",
  accountSecurity: "Sécurité du compte",
  changePassword: "Modifier le mot de passe",
  updatePasswordDesc: "Mettez à jour votre mot de passe régulièrement pour sécuriser votre compte.",
...
const esTranslations = {
  ...
  noTasksFound: "No se encontraron tareas para este período",
  ...
  deleteUserConfirm: "¿Está seguro de que desea eliminar al usuario {email}? Esta acción no se puede deshacer.",
  userDeleted: "Usuario eliminado con éxito.",
  accountSecurity: "Seguridad de la Cuenta",
  changePassword: "Cambiar Contraseña",
  updatePasswordDesc: "Actualice su contraseña periódicamente para mantener su cuenta segura.",
